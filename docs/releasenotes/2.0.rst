...
Experimental Post-Receive Webhooks for GitHub and BitBucket
-----------------------------------------------------------

We are testing new post-recieve webhooks for GitHub and BitBucket, which we'll
expand upon in upcoming releases.
...
:samp:`http://<server>/repos/<repo_id>/hooks/post-receive/`, where
