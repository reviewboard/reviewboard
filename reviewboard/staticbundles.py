...
PIPELINE_JAVASCRIPT = dict({
    ...
    'js-tests': {
        'source_filenames': (
            ...
            'rb/js/reviewRequestPage/models/tests/reviewRequestPageChangeEntryModelTests.es6.js',
            'rb/js/reviewRequestPage/models/tests/reviewRequestPageEntryModelTests.es6.js',
    ...
    'reviews': {
        'source_filenames': (
            ...
            'rb/js/reviewRequestPage/models/reviewRequestPageEntryModel.es6.js',
            'rb/js/reviewRequestPage/models/reviewRequestPageReviewEntryModel.es6.js',
            'rb/js/reviewRequestPage/models/reviewRequestPageStatusUpdatesEntryModel.es6.js',
            'rb/js/reviewRequestPage/models/reviewRequestPageChangeEntryModel.es6.js',
            ...
            'rb/js/views/initialStatusUpdatesBoxView.es6.js',
