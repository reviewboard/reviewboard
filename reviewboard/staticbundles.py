...
PIPELINE_JAVASCRIPT = dict({
    ...
    'js-tests': {
        'source_filenames': (
            ...
            'rb/js/pages/views/tests/diffViewerPageViewTests.js',
            ...
            'rb/js/reviewRequestPage/views/tests/pageViewTests.es6.js',
    ...
    'review-request-page': {
        'source_filenames': (
            ...
            'rb/js/reviewRequestPage/views/issueSummaryTableView.js',
            'rb/js/reviewRequestPage/views/pageView.es6.js',
