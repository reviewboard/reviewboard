...
class BaseReviewRequestAction(BaseAction):
    ...
    def register(
        self,
        parent: (BaseReviewRequestMenuAction | None) = None,
    ) -> None:
...
class BaseReviewRequestMenuAction(BaseMenuAction):
    ...
    def __init__(
        self,
        child_actions: (list[BaseReviewRequestAction] | None) = None,
    ) -> None:
...
def register_actions(
    actions: list[BaseReviewRequestAction | BaseReviewRequestMenuAction],
